...
public class Order implements Tradable{
 ...
 public Order(String userName,String productSymbol, Price orderPrice, int originalVolume, String orderSide){
	 delegate=TradableFactory.build(userName, productSymbol,  orderPrice,  originalVolume,  orderSide);
	// orderId= userName+productSymbol+orderPrice.toString()+currentTime;
 }
	@Override
